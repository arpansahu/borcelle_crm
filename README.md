...
```bash
  ...
  uvicorn --host 0.0.0.0 -port 8014 borcelle_crm.asgi:application
```
...
pipeline {
    ...
    environment {
        ...
        NGINX_CONF_FLOWER = "/etc/nginx/sites-available/flower-borcelle-crm"
        ENV_PROJECT_NAME = "borcelle_crm"
        DOCKER_PORT = "8014"
        FLOWER_PORT = "8052"
        PROJECT_NAME_WITH_DASH = "borcelle-crm"
        SERVER_NAME= "borcelle-crm.arpansahu.me"
        FLOWER_SERVER_NAME = "flower-borcelle-crm.arpansahu.me"
