...
Available at: https://borcelle-crm.arpansahu.space
...
services:
  web:
    build:  # This section will be used when running locally
      context: .
      dockerfile: Dockerfile
    image: harbor.arpansahu.space/library/borcelle_crm:latest
    env_file: ./.env
...
After all these steps your Nginx configuration file located at /etc/nginx/sites-available/borcelle-crm will be looking similar to this
...
server {
    ...
    server_name borcelle-crm.arpansahu.space;
    return 301 https://$host$request_uri;
}
