        ...
        - image: harbor.arpansahu.me/library/borcelle_crm:latest
          ...
          ports:
            - containerPort: 8014
              name: daphne
              command: ["/bin/sh", "-c"]
              args: ["python manage.py collectstatic --noinput && daphne borcelle_crm.asgi:application -b 0.0.0.0 --port 8014 & celery -A borcelle_crm.celery worker -l info & celery -A borcelle_crm beat -l INFO"]
```
